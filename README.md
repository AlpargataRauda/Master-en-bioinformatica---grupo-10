...
* [Results](./Results/): las salidas de cada etapa: tablas, gráficos y archivos binarios. Contiene QC_Reports/, Aligned/, VCF_Files/, y las subcarpetas graphics/, analyses/ y summary/.
